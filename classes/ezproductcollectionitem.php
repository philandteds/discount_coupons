...
class eZProductCollectionItem extends eZPersistentObject
{
    ...
    */
    function copy( $collectionID )
    {
		...
		$discountOrderItem = eZPersistentObject::fetchObject(
			eZOrderItem::definition(),
			null,
			array(
				'type'        => 'product_discount',
				'description' => $this->attribute( 'id' )
			)
		);
		if( $discountOrderItem instanceof eZOrderItem ) {
			$discountOrderItem->setAttribute( 'description', $item->attribute( 'id' ) );
